...
const AgendaNewsSection: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const newsData = await homepageService.getAllNews();
      setNews(newsData.slice(0, 3)); // Limiter à 3 actualités

      // Pour l'instant, des événements fictifs - à remplacer par un vrai service
      const mockEvents: AgendaEvent[] = [
        {
          ...
          description: 'Venez découvrir notre traditionnel marché de Noël avec ses chalets artisanaux.',
          image_url: 'https://picsum.photos/id/1050/400/300'
        },
        {
          id: '2',
          ...
          description: 'Découvrez l\'histoire de Chièvres avec notre guide passionné.',
        ...
        },
        {
          ...
          description: 'Concert exceptionnel pour clôturer l\'année en beauté.',
