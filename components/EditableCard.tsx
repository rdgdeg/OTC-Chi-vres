...
import { MapPin, Star, Phone, Globe, Timer, Footprints } from 'lucide-react';
...
const EditableCard: React.FC<EditableCardProps> = ({ place, editable = false, onImageUpdate }) => {
  ...
  const getTypeColor = (type: string) => {
    switch(type) {
      ...
      case 'cafe': return 'text-amber-600';
      case 'producer': return 'text-emerald-600';
