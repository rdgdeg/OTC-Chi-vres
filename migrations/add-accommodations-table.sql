-- ===================================
-- TABLE HÉBERGEMENTS (Version simplifiée)
-- ===================================
...
CREATE TABLE IF NOT EXISTS accommodations (
    ...
    excerpt TEXT, -- Description courte pour les listes
    
    -- Type d'hébergement
    type TEXT NOT NULL CHECK (type IN ('bed_breakfast', 'gite', 'hotel', 'camping', 'unusual')),
    
    -- Capacité et chambres
    capacity INTEGER NOT NULL, -- Nombre de personnes
    bedrooms INTEGER, -- Nombre de chambres
    beds_description TEXT, -- Description des lits (ex: "2 lits doubles, 1 lit superposé")
    
    -- Localisation
    address TEXT NOT NULL,
    village TEXT, -- Village/commune (Chièvres, Ladeuze, etc.)
    lat NUMERIC,
    lng NUMERIC,
    ...
    -- Médias (URLs simples pour l'instant)
    featured_image TEXT, -- URL de l'image principale
    gallery_images TEXT[] DEFAULT '{}', -- URLs des images de galerie
    
    -- Caractéristiques
    features TEXT[] DEFAULT '{}', -- Ce que vous aimerez
    amenities TEXT[] DEFAULT '{}', -- Équipements (WiFi, parking, etc.)
    
    -- Tarifs
    price_range TEXT, -- Ex: "80-120€/nuit"
    price_details TEXT, -- Détails sur les tarifs
    ...
    available_from DATE,
    available_to DATE,
    min_stay INTEGER DEFAULT 1, -- Séjour minimum en nuits
    ...
    -- Audit
    created_by TEXT, -- Simplifié sans référence pour l'instant
    updated_by TEXT, -- Simplifié sans référence pour l'instant
...
-- Données initiales pour les hébergements existants
