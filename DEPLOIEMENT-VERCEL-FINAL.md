# Déploiement Vercel - Gestion Page d'Accueil

## 🚀 **Déploiement Automatique**

Le push vers Git va déclencher automatiquement le déploiement sur Vercel.

### **Status du Déploiement**
- ✅ Code poussé vers GitHub (commit `12217ab`)
- 🔄 Vercel va détecter les changements et déployer automatiquement
- ⏱️ Temps estimé : 2-3 minutes

## 🗄️ **Migration Base de Données Production**

### **Étape 1 : Accéder à Supabase Production**
1. **Connectez-vous** à votre dashboard Supabase
2. **Sélectionnez votre projet** de production
3. **Allez dans SQL Editor**

### **Étape 2 : Exécuter la Migration**
Copiez-collez le contenu du fichier `migrations/add-newsletter-and-homepage-content-simple.sql` dans l'éditeur SQL et exécutez-le.

**Ou utilisez ce script complet :**

```sql
-- Migration pour la gestion de la page d'accueil et newsletter
...
Après l'exécution, vérifiez que ces tables ont été créées :
...
```
VITE_SUPABASE_URL=https://pyrqqruqvvhwmgkhlhed.supabase.co
VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
VITE_MAPBOX_TOKEN=pk.eyJ1IjoicmRnZGVnIiwiYSI6ImNtaWJ1dTR4NTA1d3gybHF6OTRqd3R1ZHYifQ...
```
...
1. **Accédez à votre site** sur Vercel
...
3. **Testez l'admin** :
   ...
   - Vérifiez le menu "Contenu Accueil"
   - Testez la modification du texte en haut
...
3. Vérifiez que la migration BDD est complète

### **Si l'admin ne fonctionne pas :**
1. Exécutez la migration SQL manuellement
2. Vérifiez les politiques RLS dans Supabase
3. Contrôlez les erreurs dans la console navigateur

## 🎉 **Fonctionnalités Déployées**

### **Page d'Accueil Dynamique**
- ✅ Bannière d'information modifiable
- ✅ Section hero personnalisable
- ✅ Actualités depuis la BDD
- ✅ Coups de cœur dynamiques
- ✅ Newsletter avec sauvegarde

### **Interface Admin**
- ✅ Menu "Contenu Accueil" avec 4 onglets
- ✅ Menu "Newsletter" avec statistiques
...
**Prochaine étape** : Exécuter la migration SQL en production  
**URL** : Votre domaine Vercel habituel